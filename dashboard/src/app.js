...
(function () {
  ...
  var STARTER_RESOURCES = [
    ...
    { title: "The Standard — six non-negotiables", type: "guide", url: EWAY_URL, ages: ["all"], topics: ["Coaching basics"], duration: "", desc: "Touches · Brave · Play · Everyone · System · every kid known by name — the rules every affiliated coach carries.", note: "Starter" },
